...
![Application Demo](https://github.com/user-attachments/assets/4c6a199e-3ffd-4d8b-ba4e-32fe31407c38)
...
![Application Dashboard](https://github.com/user-attachments/assets/86cb3865-ffb5-4872-86d0-d15487b9de3d)
...
1. Configure model parameters (horizon, confidence intervals)
   ...
   ![Application Configurations](https://github.com/user-attachments/assets/3ba89dba-3d93-4e4c-ba8b-e882e6dfc5d2)
   
2. Select forecasting model (Hybrid GAM+XGBoost, SARIMA, Prophet, or Naive baseline)
   
   ![Application Model Selection](https://github.com/user-attachments/assets/793ae1a2-5a5f-44ae-94ba-7f3fa3c1f9f5)
   
3. Visualize predictions with uncertainty bands
   
   ![Application Model Forecast](https://github.com/user-attachments/assets/ad77fee6-a3c6-4c09-957a-8299afec034a)
...
- Data preprocessing procedures
 ...
 ![Application Research](https://github.com/user-attachments/assets/47d8e617-7bf7-4fb8-a141-2ff56f84abd2)

#### 2.3.4 Index

Landing page with project overview, capabilities showcase, and call-to-action for exploration.

 ![Application Index](https://github.com/user-attachments/assets/feef9e85-916b-48d3-b769-2c069fcba812)
...
- Responsive scaling
  ...
  ![Application Visualizations](https://github.com/user-attachments/assets/7d9ba60f-a0f9-437c-b6cc-e2ed8ed3975c)

  ![Application Metrics](https://github.com/user-attachments/assets/57bad1b6-8b4e-4eac-b112-f55f2adb2498)
