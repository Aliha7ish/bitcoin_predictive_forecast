...
![Application Demo](https://github.com/Aliha7ish/bitcoin_predictive_forecast/issues/1#issue-4319511231)
...
4. Export forecast data in multiple formats

#### 2.3.3 Insights

Advanced analytics and statistical analysis:

- Decomposition visualization (trend, seasonal, residual)
- Stationarity diagnostics (ADF test results)
...
Forecasts and analysis results can be exported in:
